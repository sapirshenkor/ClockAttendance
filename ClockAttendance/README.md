צודק לגמרי 👍
מה שנתתי לך היה בתוך בלוק — אבל עם `id` שמפריע לקופי-פייסט נקי ל-README.

עכשיו אני נותן לך **גרסה נקייה לגמרי, מוכנה להדבקה ישירות ל־README.md** (בלי שום תוספות/IDים/שטויות).
